...
<h1>GeoJSON Polygon Layers</h1>
	...
	<div id="map_wrapper" style="width: 100%; position: relative; height: 600px;">
		<div id="map_canvas" style="border: 1px solid #999; height: 500px; width: 600px; position: relative; float: right;"></div>
		<div>
			<p>Loading Polygon and MultiPolygons from GeoJSON files using jQuery, and populating a jsMapTools object.</p>
		</div>
		...
		$(document).ready(function(){
			...
			google.maps.event.addListenerOnce(map, 'idle', function(){
				...
				function loadMultiPolygonGeoJSON(jsonFile){
					$.getJSON(jsonFile, function(layers) {     
						//alert(layers.features[0].geometry.type);
